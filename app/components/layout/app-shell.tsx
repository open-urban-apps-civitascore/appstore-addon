...
/**
 * App frame with a responsive sidebar: a permanent column from `lg` up, an
 * off-canvas drawer below it (one DOM instance, moved by CSS). The drawer state
 * lives in context so the trigger can sit inside the server-rendered header.
 */
